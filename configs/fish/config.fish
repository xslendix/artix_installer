...
set -x proton STEAM_COMPAT_DATA_PATH=~/.proton/ /home/slendi/.local/share/Steam/steamapps/common/Proton\ 3.7/proton

set -xa PATH /home/slendi/android-studio/bin \
	$HOME/opt/cross/bin \
	$PSPDEV/bin \
	$HOME/.local/share/Steam/steamapps/common/Proton\ 3.7/proton \
